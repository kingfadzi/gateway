...
package com.example.onboarding.requirements.service;

import com.example.onboarding.policy.dto.OpaRequest;
import com.example.onboarding.policy.dto.PolicyDecision;
import com.example.onboarding.policy.dto.PolicyInput;
import com.example.onboarding.requirements.dto.RequirementsView;
import com.example.onboarding.requirements.dto.RequirementsView.RequirementView;
import com.example.onboarding.requirements.dto.RequirementsView.Parts;
import com.example.onboarding.requirements.dto.RequirementsView.Part;
import com.example.onboarding.evidence.dto.ReuseCandidate;                  // <-- use dto.evidence
import com.example.onboarding.integrations.OpaClient;
import com.example.onboarding.evidence.repository.EvidenceReuseRepository;   // profile context reader
import com.example.onboarding.policy.repository.RequirementsMapper;         // OPA -> FE mapper
import com.example.onboarding.evidence.service.EvidenceReuseService;        // <-- correct service package
