...
public class EvidenceController {
    ...
    public Evidence createJson(@PathVariable String appId,
    ...
    public Evidence createMultipart(@PathVariable String appId,
    ...
    public Evidence get(@PathVariable String id) {
    ...
    public ResponseEntity<List<Evidence>> list(
