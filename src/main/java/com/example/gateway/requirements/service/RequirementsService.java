...
package com.example.gateway.requirements.service;

import com.example.gateway.policy.dto.OpaRequest;
import com.example.gateway.policy.dto.PolicyDecision;
import com.example.gateway.policy.dto.PolicyInput;
import com.example.gateway.requirements.dto.RequirementsView;
import com.example.gateway.requirements.dto.RequirementsView.RequirementView;
import com.example.gateway.requirements.dto.RequirementsView.Parts;
import com.example.gateway.requirements.dto.RequirementsView.Part;
import com.example.gateway.evidence.dto.ReuseCandidate;                  // <-- use dto.evidence
import com.example.gateway.integrations.OpaClient;
import com.example.gateway.evidence.repository.EvidenceReuseRepository;   // profile context reader
import com.example.gateway.policy.repository.RequirementsMapper;         // OPA -> FE mapper
import com.example.gateway.evidence.service.EvidenceReuseService;        // <-- correct service package
