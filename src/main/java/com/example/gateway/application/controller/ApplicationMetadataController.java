...
public class ApplicationMetadataController {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ApplicationMetadataController.class);

    private final ApplicationMetadataService service;

    public ApplicationMetadataController(ApplicationMetadataService service) {
